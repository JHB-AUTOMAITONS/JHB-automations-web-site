            ...
            <div className="lg:sticky lg:top-6 lg:h-fit">
              ...
              <div className="mt-2 max-h-[60vh] overflow-y-auto rounded-2xl border border-ink/10 bg-base p-5 shadow-soft">
                ...
                {doc.contentHtml.trim() ? (
                  <div className="prose-jhb mt-4 text-sm leading-relaxed text-ink/80 [&_a]:text-primary [&_h2]:mt-4 [&_h2]:font-display [&_h2]:text-base [&_h2]:font-bold [&_ul]:list-disc [&_ul]:pl-5 [&_p]:mt-2" dangerouslySetInnerHTML={{ __html: sanitizeRichText(doc.contentHtml) }} />
                ) : (
