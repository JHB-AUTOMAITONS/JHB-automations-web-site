...
export type Product = {
  ...
  // Per-section visibility (see the `hidden` convention above). Absent = shown.
  heroHidden?: boolean;
  // Hides just the hero's "Book a Free Demo" / "About {title}" button row,
  // independent of heroHidden (which hides the whole hero, badge and all).
  heroButtonsHidden?: boolean;
  overviewHidden?: boolean;
...
export const PRODUCTS_DEFAULT: ProductsDoc = {
  items: [
    ...
    },
    {
      ...
      metaDescription:
        "JHB Automations' EV Charging Management System is a Charging Station Management System (CSMS) — EV charger monitoring, session management, payments, and OCPP/OCPI support. Custom EV charging software development.",
      metaKeywords:
        "CSMS, charging station management system, EV charging software, OCPP integration, OCPI integration, EV charging mobile app development, custom EV charging software development, EV charger management system",
      ogTitle: "EV Charging Management System",
      ogDescription:
        "A complete CSMS built by JHB Automations — charger monitoring, session management, payments and OCPP/OCPI support, plus custom EV charging software development.",
      status: "published",
      sortOrder: 4,
      about: {
        heroTitle: "About the EV Charging Management System",
        heroDescription:
          "Our EV Charging Management System is JHB Automations' own Charging Station Management System — built end-to-end to show exactly what our team can deliver for a business that needs real EV charging software, not just a proof of concept.",
        image: null,
        imageAlt: "",
        overview:
          "EV charging hardware is only half the picture — the other half is the software that monitors it, runs charging sessions, authenticates users, and settles payments. We built it to prove we could deliver that other half ourselves: a working CSMS backend, an admin dashboard, and mobile apps published on the Google Play Store and Apple App Store, built around the OCPP and OCPI standards rather than a closed, proprietary connection to hardware. It's also the foundation we draw on when building custom EV charging software for other businesses.",
        features: [
        ...
        ctaText:
          "Tell us about your chargers and operations, and we'll show you how a JHB Automations-built CSMS — backend, dashboard and mobile app — can be built around them.",
        ctaButtonLabel: "Book a Free Demo",
        ctaButtonHref: "/#contact",
        metaTitle: "About the EV Charging Management System by JHB Automations",
        metaDescription:
          "JHB Automations' EV Charging Management System is our own Charging Station Management System (CSMS) — see how it works and how we build custom EV charging software for other businesses.",
        ogImage: "",
        ogTitle: "About the EV Charging Management System — Built by JHB Automations",
        ogDescription:
          "A real, working CSMS built end-to-end by JHB Automations — backend, dashboard, mobile apps and payments.",
        canonical: "",
      },
    },
  ],
